...
<head>
	...
	<!-- FAVICON -->
	<link rel="apple-touch-icon" href="<?=_DOMINIO_?>assets/dist/images/icon-100x100.png" />
	<link rel="shortcut icon" type="image/png" href="<?=_DOMINIO_?>assets/dist/images/icon-100x100.png" />
	<link rel="icon" type="image/png" sizes="32x32" href="<?=_DOMINIO_?>assets/dist/images/icon-100x100.png" />
	<link rel="icon" type="image/png" sizes="16x16" href="<?=_DOMINIO_?>assets/dist/images/icon-100x100.png" />

	<link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;500;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="<?=_ASSETS_?>dist/css/style.css">
            ...
            <div class="container">
                <div class="site-header-inner">
                    <div class="brand header-brand">
                        <h1 class="m-0">
                            <a href="<?=_DOMINIO_?>">
								<img src="<?=_ASSETS_?>dist/images/icon-100x100.png" title="<?=_TITLE_?>" width="50px" />
                            </a>
                        </h1>
                    </div>
                </div>
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">Be Budget Today</h1>
	                        <p class="hero-paragraph"><?=_DESCRIPTION_?></p>
	                        <!-- <div class="hero-cta">
						...
						<div class="hero-app">
							...
							<img class="device-mockup" src="<?=_ASSETS_?>dist/images/iphone-mockup.png" alt="App preview">
            ...
            <section class="features section">
                <div class="container">
					<div class="features-inner section-inner has-bottom-divider">
						<h2 class="section-title mt-0">Smart features for smarter budgeting</h2>
                        <div class="features-wrap">
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    <h3 class="feature-title mt-24">💰 Instant Expense Tracking</h3>
                                    <p class="text-sm mb-0">Add expenses or income in seconds — no clutter, no confusion.</p>
                                </div>
                            </div>
							<div class="feature is-revealing">
                                <div class="feature-inner">
                                    <h3 class="feature-title mt-24">📊 Visual Monthly Overview</h3>
                                    <p class="text-sm mb-0">Understand where your money goes with clear charts and insights.</p>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    <h3 class="feature-title mt-24">🧠 Smart Categorization</h3>
                                    <p class="text-sm mb-0">Automatic category suggestions based on your spending patterns.</p>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    <h3 class="feature-title mt-24">💼 Personal Budgets</h3>
                                    <p class="text-sm mb-0">Set spending limits by category and stay on track effortlessly.</p>
                                </div>
                            </div>
							<div class="feature is-revealing">
                                <div class="feature-inner">
                                    <h3 class="feature-title mt-24">📅 History & Trends</h3>
                                    <p class="text-sm mb-0">Review your past months and spot habits worth changing.</p>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    <h3 class="feature-title mt-24">☁️ Secure Cloud Sync</h3>
                                    <p class="text-sm mb-0">Your data stays private, safe, and always accessible.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="site-footer-inner has-top-divider">
                    ...
                    <ul class="footer-links list-reset">
                        <li>
                            <a href="<?=_DOMINIO_?>">Privacy policy</a>
                        </li>
                        <li>
                            <a href="<?=_DOMINIO_?>">Cookies policy</a>
                        </li>
                        <li>
                            <a href="<?=_DOMINIO_?>">FAQ's</a>
                        </li>
                    </ul>
                    <ul class="footer-social-links list-reset">
                        <li>
                            <a href="<?=_DOMINIO_?>" style="opacity: 0.3; cursor: not-allowed;" title="Not available">
                    ...
                    <div class="footer-copyright">&copy; <?=date('Y')?> Be Budget Today, all rights reserved.</div>
                </div>
            </div>
        </footer>
    </div>

    <script src="<?=_ASSETS_?>dist/js/main.min.js"></script>
</body>
</html>
